...
<html>
	...
	<body class="whiteBody">
		...
		<form  class="search" action="searchSelfProblem" method="post">
			<input type="text" name="keyword" id="keyword" placeholder="Chercher un problème dans mon repertoire.." required="required">
		...
		<div class="centeredDiv">
			<div class="leftDiv" style="margin:40px; padding:0;">
				...
				<form id="form" action="saveSelfProb" method="post" style="display: none;">	
				...
				<!-- Liste des problèmes -->
				<div class="divReplyTitle">
					<h2>${problems.size()} mes problèmes </h2>
				</div>
					...
					<div class="reply">
						 <div class="reply-content">
							...
							<div class="reply-footer" style="border-top: 1px solid #80bfff;">
								...
								<p class="right">
									<a href="deleteSelfProblem?idPr=${pr.idPr }"><i class="material-icons">delete</i></a>
								<p>
							</div>
						</div>
					</div>
